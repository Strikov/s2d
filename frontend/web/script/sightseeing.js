            ...
            <div className="sort">
                <form>
                    <ul className="sort_type">
                        <li>Сортувати за: </li>
                        <li className="sort_type_checkbox"> <div className="sort_checkbox sort_checkbox_active" id="new"></div> <p>Новизною</p></li>
                        <li className="sort_type_checkbox"> <div className="sort_checkbox" id="rate"></div> <p>Рейтингом</p></li>
                    </ul>
                </form>
            </div>  
        );
